...
我的Ubuntu系统终端配置，包括Zsh的安装以及Oh My Zsh的配置。
...
在[External plugins-Wiki](https://github.com/ohmyzsh/ohmyzsh/wiki/External-plugins)中查看可供选择的第三方插件以及第三方插件的安装方法。
...
3. [Oh My Zsh-简书](https://www.jianshu.com/p/b8a80dd59414)
4. [Oh My Zsh-博客园](https://www.cnblogs.com/lcgbk/p/13255836.html)
5. [ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh)
6. [配置一个简洁高效的Zsh丨Linux中国-Linux中国的文章-知乎](https://zhuanlan.zhihu.com/p/345559097)
7. [zsh&oh-my-zsh的配置与使用-SCEtoAUX的文章-知乎](https://zhuanlan.zhihu.com/p/58073103)
8. [Ubuntu install of ROS Melodic](http://wiki.ros.org/melodic/Installation/Ubuntu)
9. [安装Zsh后ROS相关命令失效-CSDN博客](https://blog.csdn.net/Amazingren/article/details/81746176)
10. [rosinstall/NonBashShells](http://wiki.ros.org/rosinstall/NonBashShells)
