...
6. [Linux黑话解释：什么是Linux中的GUI、CLI和TUI？丨Linux中国-Linux中国的文章-知乎](https://zhuanlan.zhihu.com/p/282776001)
7. [Update Ubuntu Terminal Color Scheme](https://linuxhint.com/ubuntu_terminal_color_scheme/)
8. [Colours and formatting in Gnome/Ubuntu's Terminal](https://www.growingwiththeweb.com/2015/05/colours-in-gnome-terminal.html)
...
12. [配置一个简洁高效的Zsh丨Linux中国-Linux中国的文章-知乎](https://zhuanlan.zhihu.com/p/345559097)
13. [zsh&oh-my-zsh的配置与使用-SCEtoAUX的文章-知乎](https://zhuanlan.zhihu.com/p/58073103)
14. [Oh My Zsh和Powerlevel10k：天作之合丨Linux中国-Linux中国的文章-知乎](https://zhuanlan.zhihu.com/p/598042205)
15. [Powerlevel9k：zsh下最棒的Powerline主题-FanDean的文章-知乎](https://zhuanlan.zhihu.com/p/125522215)
16. [Ubuntu install of ROS Melodic-ROS Wiki](http://wiki.ros.org/melodic/Installation/Ubuntu)
17. [安装Zsh后ROS相关命令失效-CSDN博客](https://blog.csdn.net/Amazingren/article/details/81746176)
18. [rosinstall/NonBashShells-ROS Wiki](http://wiki.ros.org/rosinstall/NonBashShells)
19. [Ubuntu用Terminator+ZSH打造好用的终端开发环境-很酷的程序员的文章-知乎](https://zhuanlan.zhihu.com/p/346665734)
20. [切换终端-CSDN博客](https://blog.csdn.net/learning_tortosie/article/details/102581261)
21. [gnome-terminator/terminator](https://github.com/gnome-terminator/terminator)
22. [Terminator](https://terminator-gtk3.readthedocs.io/en/latest/)
