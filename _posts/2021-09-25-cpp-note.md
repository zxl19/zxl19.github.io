...
C++11支持通过`using`关键字指定别名，作用与`typedef`相同：
...
4. `std::weak_ptr`：弱共享指针，不会引起引用计数变化，不单独使用，通常结合共享指针使用，用于解决循环引用问题；
...
16. [C++类型转换：强制类型转换和隐式类型转换（附带实例）-C语言中文网](https://c.biancheng.net/view/dleoa3p.html)
...
21. [size_t和int1-CSDN博客](https://blog.csdn.net/wc11223/article/details/70553583)
22. [size_t和int2-CSDN博客](https://blog.csdn.net/qq_41598072/article/details/84924997)
23. [NULL和nullptr-CSDN博客](https://blog.csdn.net/qq_18108083/article/details/84346655)
24. [嵌套模板中的>>1-Stack Overflow](https://stackoverflow.com/questions/6695261/template-within-template-why-should-be-within-a-nested-template-arg)
25. [嵌套模板中的>>2-Stack Overflow](https://stackoverflow.com/questions/7087033/for-nested-templates-when-did-become-standard-c-instead-of)
26. [C++11新特性，所有知识点都在这了！-程序喵大人的文章-知乎](https://zhuanlan.zhihu.com/p/139515439)
27. [C++11 auto和decltype关键字-C语言中文网](https://c.biancheng.net/view/438.html)
28. [C++返回值类型后置（跟踪返回值类型）-C语言中文网](https://c.biancheng.net/view/3727.html)
29. [C++ =default和=delete的用法-C语言中文网](https://c.biancheng.net/view/llklmn6.html)
30. [C++随笔：关键字 =default 和 =delete-灵知子的文章-知乎](ttps://zhuanlan.zhihu.com/p/430916670)
31. [default和delete-CSDN博客](https://blog.csdn.net/lmb1612977696/article/details/80035487)
32. [C++里写一个函数体为空的构造函数和构造函数=default这两种写法有何区别？-吴咏炜的回答-知乎](https://www.zhihu.com/question/660310880/answer/1960455078537327960)
33. [C++11使用using定义别名（替代typedef）-C语言中文网](https://c.biancheng.net/view/3730.html)
34. [C++中using的三种用法-算法集市的文章-知乎](https://zhuanlan.zhihu.com/p/156155959)
35. [c++是否应避免使用普通指针，而使用智能指针（包括shared，unique，weak）？-张小方的回答-知乎](https://www.zhihu.com/question/319277442/answer/1517987598)
36. [现代C++：一文读懂智能指针-FOCUS的文章-知乎](https://zhuanlan.zhihu.com/p/150555165)
37. [C++智能指针-小小将的文章-知乎](https://zhuanlan.zhihu.com/p/54078587)
38. [C++11智能指针丨巨巨巨详细-Phoenix Studio的文章-知乎](https://zhuanlan.zhihu.com/p/670068158)
39. [如何看待无脑shared_ptr的行为?-南山烟雨珠江潮的回答-知乎](https://www.zhihu.com/question/1896659962521950180/answer/1896983798891141034)
40. [C++11 shared_ptr智能指针-C语言中文网](https://c.biancheng.net/view/7898.html)
41. [C++11 shared_ptr（智能指针）详解-C语言中文网](https://c.biancheng.net/view/430.html)
42. [C++11 unique_ptr智能指针详解-C语言中文网](https://c.biancheng.net/view/7909.html)
43. [C++11 weak_ptr智能指针-C语言中文网](https://c.biancheng.net/view/7918.html)
44. [C++ std::weak_ptr智能指针详解-C语言中文网](https://c.biancheng.net/view/i0apv5s.html)
45. [std::unique_ptr release的使用-博客园](https://www.cnblogs.com/zengtx/p/11911853.html)
46. [C++11 lambda匿名函数用法详解-C语言中文网](https://c.biancheng.net/view/7818.html)
47. [C++11 lambda表达式精讲-C语言中文网](https://c.biancheng.net/view/3741.html)
48. [C++11 Lambda表达式（匿名函数）详解-C语言中文网](https://c.biancheng.net/view/433.html)
