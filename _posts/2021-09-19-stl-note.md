...
5. `sort()`函数在对于自定义数据类型进行排序时需要定义比较函数`comp`，实现`<`运算符对应的逻辑：
    ...
    - 比较函数`comp`通常定义为类中的静态函数或lambda表达式；
...
16. [【C++11】让程序更简洁—std::function轻松实现回调函数-CPP开发前沿的文章-知乎](https://zhuanlan.zhihu.com/p/363511039)
17. [C++ std::function的用法-CSDN博客](https://blog.csdn.net/hzy925/article/details/79676085)
