...
1. 关联容器的底层实现使用红黑树的存储结构，适用于使用迭代器遍历容器中存储的元素；
    ...
    - 查找、插入、删除的平均时间复杂度为O(logN)，最坏时间复杂度为O(logN)；

2. 无序关联容器的底层实现使用哈希表的存储结构，适用于通过指定键查找对应的值；

    - 查找、插入、删除的平均时间复杂度为O(1)，最坏时间复杂度为O(N)；
    - 哈希冲突（hash collision）：不同的键通过哈希函数映射后获得相同的哈希值；
    - 链地址法（separate chaining）：发生哈希冲突时，冲突元素以链表形式串联在桶中，退化为遍历查找；
...
// !论文使用开放寻址法，需要指定哈希表大小，std::unordered_map使用链地址法，不需要指定哈希表大小
/// @see https://github.com/NVlabs/instant-ngp/issues/59
/// @see https://github.com/NVlabs/tiny-cuda-nn/commit/d0639158dd64b5d146d659eb881702304abaaa24
template <>
inline size_t hash_vec<3>::operator()(const Eigen::Matrix<int, 3, 1>& v) const {
    return size_t(((v[0]) * 73856093) ^ ((v[1]) * 25165843) ^ ((v[2]) * 83492791));
}
...
S::iterator remove(s.begin(), s.end(), val);    // 移除区间内指定值元素，返回指向新区间尾部的迭代器
S::iterator unique(s.begin(), s.end());         // 去除区间内相邻的重复元素，返回指向新区间尾部的迭代器
...
void stable_sort(s.begin(), s.end());                               // 对区间元素进行稳定排序，默认以元素值的大小做升序排序，保留值相等元素的相对位置
void partial_sort(s.begin(), s.begin() + n, s.end());               // 对区间元素进行部分排序，默认以元素值的大小做升序排序，前n个元素有序，其余元素顺序不变
void partial_sort_copy(s1.begin(), s1.end(), s2.begin(), s2.end()); // 对区间元素进行部分排序，默认以元素值的大小做升序排序，将排序后的元素拷贝到另一个容器中
...
1. 内存空间充足时，时间复杂度为O(NlogN)，倾向于使用移动语义；
2. 内存空间不足时，时间复杂度为O(N(logN)^2)，倾向于使用交换；
...
9. [为什么有人把std::vector（向量）当做数组用？-吴咏炜的回答-知乎](https://www.zhihu.com/question/9809215395/answer/81827329759)
10. [size()-CSDN博客](https://blog.csdn.net/renhaofan/article/details/90369219)
11. [clear()、swap()、shrink_to_fit()-CSDN博客](https://blog.csdn.net/zhizhengguan/article/details/107781428)
12. [C++容器使用reserve的重要性，以及如何释放多余内存-江南古镇的文章-知乎](https://zhuanlan.zhihu.com/p/137816149)
13. [c++中为什么不提倡使用vector\<bool\>？-哈乐笑的回答-知乎](https://www.zhihu.com/question/23367698/answer/148258487)
14. [c++中为什么不提倡使用vector\<bool\>？-Hydrogen的回答-知乎](https://www.zhihu.com/question/23367698/answer/2837413461)
