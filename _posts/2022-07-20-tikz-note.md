...
TikZ是PGF（Portable Graphic Format）的前端，其名称来源于德语TikZ ist kein Zeichenprogramm，意为TikZ is not a drawing program，是一个GNU形式的递归缩写。
...
5. [j-vaught/tikzgif](https://github.com/j-vaught/tikzgif)
