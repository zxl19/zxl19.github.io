...
2. 点云的定义：
    ...
    - 为了实现内存对齐，使用SSE指令集进行向量化运算加速，可以使用`std::vector<Eigen::Vector3f, Eigen::aligned_allocator<Eigen::Vector3f>>`来保存点云中点的坐标；
...
3. [pcl::PointXYZRGBA-Stack Overflow](https://stackoverflow.com/questions/15999331/how-can-i-change-rgb-values-of-pclpointxyzrgba)
4. [Using STL Containers with Eigen](https://eigen.tuxfamily.org/dox/group__TopicStlContainers.html)
5. [点云与点云指针类型转换1-CSDN博客](https://blog.csdn.net/h287850870/article/details/80988552)
6. [点云与点云指针类型转换2-CSDN博客](https://blog.csdn.net/tfb760/article/details/115101393)
